...
<!-- Name -->
										<div class="col-lg-6">
											<input type="text" name="nombre" id="checkout_name" class="checkout_input" placeholder="Nombre" required="required">
                                            </div>
<!-- Last Name -->									
										<div class="col-lg-6">
											<input type="text" name="apellido" id="checkout_last_name" class="checkout_input" placeholder="Apellido" required="required">
										</div>
									</div>
									<div>
<!-- Country -->
...
<!-- Address -->									
									<div>
										<input type="text" name="domicilio" id="checkout_address" class="checkout_input" placeholder="Direccion" required="required">
									</div>
<!-- Phone # -->									
									<div>
										<input type="phone" name="telefono" id="checkout_phone" class="checkout_input" placeholder="Telefono" required="required">
									</div>
<!-- Email -->									
									<div>
										<input type="phone" name="email" id="checkout_email" class="checkout_input" placeholder="Email" required="required">
									</div>
